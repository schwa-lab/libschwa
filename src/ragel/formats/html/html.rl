...
%%{
  ...
  html4_doctype_strict_a          = '-//W3C//DTD HTML 4.0' '1'? '//EN' ;
  html4_doctype_transitional_a    = '-//W3C//DTD HTML 4.0' '1'? ' Transitional//EN' ;
  html4_doctype_frameset_a        = '-//W3C//DTD HTML 4.0' '1'? ' Frameset//EN' ;
  xhtml1_0_doctype_strict_a       = '-//W3C//DTD XHTML 1.0 Strict//EN' ;
  xhtml1_0_doctype_transitional_a = '-//W3C//DTD XHTML 1.0 Transitional//EN' ;
  xhtml1_0_doctype_frameset_a     = '-//W3C//DTD XHTML 1.0 Frameset//EN' ;
  xhtml1_1_doctype_strict_a       = '-//W3C//DTD XHTML 1.1//EN' ;
  xhtml1_1_doctype_basic_a        = '-//W3C//DTD XHTML Basic 1.1//EN' ;
  html4_doctype_strict_b          = 'http://www.w3.org/TR/html4/strict.dtd' ;
  html4_doctype_transitional_b    = 'http://www.w3.org/TR/html4/loose.dtd' ;
  html4_doctype_frameset_b        = 'http://www.w3.org/TR/html4/frameset.dtd' ;
  xhtml1_0_doctype_strict_b       = 'http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd' ;
  xhtml1_0_doctype_transitional_b = 'http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd' ;
  xhtml1_0_doctype_frameset_b     = 'http://www.w3.org/TR/xhtml1/DTD/xhtml1-frameset.dtd' ;
  xhtml1_1_doctype_strict_b       = 'http://www.w3.org/TR/xhtml11/DTD/xhtml11.dtd' ;
  xhtml1_1_doctype_basic_b        = 'http://www.w3.org/TR/xhtml-basic/xhtml-basic11.dtd' ;
  ...
  title_tag = '<title'i ( space+ attribute )* space* '>' ((text | [<])* -- '</title')  '</title'i space* '>' ;
  textarea_tag = '<textarea'i ( space+ attribute )* space* '>' ((text | [<])* -- '</textarea')  '</textarea'i space* '>' ;
  script_tag = '<script'i ( space+ attribute )* space* '>' ((text_character | [<])* -- '</script')  '</script'i space* '>' ;
  style_tag = '<style'i ( space+ attribute )* space* '>' ((text_character | [<])* -- '</style')  '</style'i space* '>' ;
