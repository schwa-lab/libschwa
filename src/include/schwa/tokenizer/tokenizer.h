...
namespace schwa {
  ...
  namespace tokenizer {
    ...
    protected:
      ...
      bool tokenize_(Stream &dest, State &s, const char *&n1, const char *&n2, const char *p, const char *pe, const char *eof, int errors=ERROR_SKIP) const;
      ...
      void split_(Type type1, Type type2, Stream &dest, State &state, const char *norm1=0, const char *norm2=0) const;
