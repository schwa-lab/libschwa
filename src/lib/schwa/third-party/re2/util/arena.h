...
#ifndef SCHWA_THIRD_PARTY_RE2_UTIL_ARENA_H_
#define SCHWA_THIRD_PARTY_RE2_UTIL_ARENA_H_
...
inline void* operator new(size_t size,
                          schwa::third_party::re2::AllocateInArenaType /* unused */,
                          schwa::third_party::re2::UnsafeArena *arena) {
  return reinterpret_cast<char*>(arena->GetMemory(size, 1));
}

#endif  // SCHWA_THIRD_PARTY_RE2_UTIL_ARENA_H_
