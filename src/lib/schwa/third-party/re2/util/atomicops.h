...
#ifndef SCHWA_THIRD_PARTY_RE2_UTIL_ATOMICOPS_H__
#define SCHWA_THIRD_PARTY_RE2_UTIL_ATOMICOPS_H__
...
static inline void WriteMemoryBarrier() {
  ...
  schwa::third_party::re2::Mutex mu;
  schwa::third_party::re2::MutexLock l(&mu);
}
...
#endif  // SCHWA_THIRD_PARTY_RE2_UTIL_ATOMICOPS_H__
