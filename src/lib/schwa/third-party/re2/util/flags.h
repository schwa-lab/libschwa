...
#ifndef SCHWA_THIRD_PARTY_RE2_UTIL_FLAGS_H__
#define SCHWA_THIRD_PARTY_RE2_UTIL_FLAGS_H__

#define DEFINE_flag(type, name, deflt, desc) \
	namespace schwa { namespace third_party { namespace re2 { type FLAGS_##name = deflt; } } }

#define DECLARE_flag(type, name) \
	namespace schwa { namespace third_party { namespace re2 { extern type FLAGS_##name; } } }
...
#endif  // SCHWA_THIRD_PARTY_RE2_UTIL_FLAGS_H__
