...
#ifndef SCHWA_THIRD_PARTY_RE2_TESTING_REGEXP_GENERATOR_H__
#define SCHWA_THIRD_PARTY_RE2_TESTING_REGEXP_GENERATOR_H__

#include <string>
#include <vector>
#include <schwa/third-party/re2/util/random.h>
...
#endif  // SCHWA_THIRD_PARTY_RE2_TESTING_REGEXP_GENERATOR_H__
