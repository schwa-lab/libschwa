...
%%{
  ...
  cont_d = ("'d" @s2 | "&#39;d" @s6 | "&apos;d" @s7 | 0xe2 0x80 0x99 "d" @s4 | "&#8217;d" @s8 | "&#x2019;"i "d" @s9 | "&rsquo;d" @s8 | 0x92 "d" @s2) @{n2="'d";};
  cont_m = ("'m" @s2 | "&#39;m" @s6 | "&apos;m" @s7 | 0xe2 0x80 0x99 "m" @s4 | "&#8217;m" @s8 | "&#x2019;"i "m" @s9 | "&rsquo;m" @s8 | 0x92 "m" @s2) @{n2="'m";};

  cont_D = ("'D" @s2 | "&#39;D" @s6 | "&apos;D" @s7 | 0xe2 0x80 0x99 "D" @s4 | "&#8217;D" @s8 | "&#x2019;"i "D" @s9 | "&rsquo;D" @s8 | 0x92 "D" @s2) @{n2="'D";};
  cont_M = ("'M" @s2 | "&#39;M" @s6 | "&apos;M" @s7 | 0xe2 0x80 0x99 "M" @s4 | "&#8217;M" @s8 | "&#x2019;"i "M" @s9 | "&rsquo;M" @s8 | 0x92 "M" @s2) @{n2="'M";};

  cont_ll = ("'ll" @s3 | "&#39;ll" @s7 | "&apos;ll" @s8 | 0xe2 0x80 0x99 "ll" @s5 | "&#8217;ll" @s9 | "&#x2019;"i "ll" @s10 | "&rsquo;ll" @s9 | 0x92 "ll" @s2) @{n2="'ll";};
  cont_re = ("'re" @s3 | "&#39;re" @s7 | "&apos;re" @s8 | 0xe2 0x80 0x99 "re" @s5 | "&#8217;re" @s9 | "&#x2019;"i "re" @s10 | "&rsquo;re" @s9 | 0x92 "re" @s2) @{n2="'re";};
  cont_ve = ("'ve" @s3 | "&#39;ve" @s7 | "&apos;ve" @s8 | 0xe2 0x80 0x99 "ve" @s5 | "&#8217;ve" @s9 | "&#x2019;"i "ve" @s10 | "&rsquo;ve" @s9 | 0x92 "ve" @s2) @{n2="'ve";};
  ...
  cont_not = ("n't" @s3 | "n&#39;t" @s7 | "n&apos;t" @s8 | "n" 0xe2 0x80 0x99 "t" @s5 | "n&#8217;t" @s9 | "n&#x2019;"i "t" @s10 | "n&rsquo;t" @s9 | "n" 0x92 "t" @s3) @{n2="n't";};
  cont_NOT = ("N'T" @s3 | "N&#39;T" @s7 | "N&apos;T" @s8 | "N" 0xe2 0x80 0x99 "T" @s5 | "N&#8217;T" @s9 | "N&#x2019;"i "T" @s10 | "N&rsquo;T" @s9 | "N" 0x92 "T" @s3) @{n2="N'T";};
